...
uses
  ...
  LMDCustomShapeHint, LMDShapeHint, LMDCustomComboBox, LMDComboBox,
  rmComboBox, DCChoice, rmBaseEdit, rmBtnEdit, RxGrdCpt;
...
procedure TFrmRelCliente.btnDeletarClick(Sender: TObject);
begin
QRCliente:= TQRCliente.Create(application);
If cmbDestino.Text= 'V�deo' Then
	QRCliente.Preview
...
procedure TFrmRelCliente.fcImageBtn1Click(Sender: TObject);
begin
  Close;
end;
