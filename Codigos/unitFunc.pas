...
procedure TFrmVendedor.lkcmbCargoEnter(Sender: TObject);
begin
...
procedure TFrmVendedor.RxDBSalExit(Sender: TObject);
begin
  If NovoItem Then
    Begin
...
procedure TFrmVendedor.DBEendExit(Sender: TObject);
begin
  If NovoItem Then
    If DBEend.Text= '' then
      Begin
...
procedure TFrmVendedor.DBEnumExit(Sender: TObject);
begin
  If NovoItem Then
...
procedure TFrmVendedor.DBEbairroExit(Sender: TObject);
begin
  If NovoItem Then
...
procedure TFrmVendedor.DBEcidadeExit(Sender: TObject);
begin
  If NovoItem Then
...
procedure TFrmVendedor.DBEcepExit(Sender: TObject);
begin
  If NovoItem Then
    If DBEcep.Text= '        ' then
      Begin
...
procedure TFrmVendedor.dbLookCargoExit(Sender: TObject);
begin
  If NovoItem Then
    Begin
    If DbLookCargo.Text= '' then
...
procedure TFrmVendedor.dbNomeExit(Sender: TObject);
Var
  Tabela: TTable;
begin
  If NovoItem Then
...
procedure TFrmVendedor.DBedtNascExit(Sender: TObject);
begin
  If NovoItem Then
...
procedure TFrmVendedor.dbcmbParenExit(Sender: TObject);
Var
  x:integer;
  Flag:Boolean;
begin
...
procedure TFrmVendedor.DCPage3Show(Sender: TObject);
begin
  NovoItem:=True;
...
procedure TFrmVendedor.btnGravaDepClick(Sender: TObject);
Var
  Campos:String;
  Vazio,Gravar,Flag:Boolean;
  x:Integer;
...
procedure TFrmVendedor.DCPage3Exit(Sender: TObject);
begin
  NovoItem:=False;
  dmDados.tbDepenFunc.Cancel;
end;

procedure TFrmVendedor.DCPageControl1Changing(Sender: TObject;
  var AllowChange: Boolean);
begin
